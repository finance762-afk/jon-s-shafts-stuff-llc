...
<section class="legal-content">
  <div class="content-narrow">
    ...
    <p>To exercise these rights, contact us at <a href="mailto:<?php echo htmlspecialchars($companyEmail); ?>"><?php echo htmlspecialchars($companyEmail); ?></a><?php if (!empty($companyPhone)): ?> or call <a href="tel:<?php echo htmlspecialchars($companyPhone); ?>"><?php echo htmlspecialchars($companyPhone); ?></a><?php endif; ?>. We will respond within 45 days.</p>
    ...
    <ul>
      ...
      <li><strong>Opt-out:</strong> Text <strong>STOP</strong> to cancel at any time. You may also opt out by emailing <a href="mailto:<?php echo htmlspecialchars($companyEmail); ?>"><?php echo htmlspecialchars($companyEmail); ?></a><?php if (!empty($companyPhone)): ?>, calling <a href="tel:<?php echo htmlspecialchars($companyPhone); ?>"><?php echo htmlspecialchars($companyPhone); ?></a>,<?php endif; ?> or any other reasonable method. We will honor all reasonable opt-out requests.</li>
    ...
    <p style="margin-top:var(--space-8);font-size:var(--font-size-sm);color:var(--color-gray);font-style:italic;">This Privacy Policy is provided as a general template. We recommend reviewing this document with a licensed <?php echo htmlspecialchars($companyState); ?> attorney before publication.</p>
  </div>
</section>
